                    ...
                    <div className="row">
                        <div className="col-xl-6 col-lg-8">
                            <ul className="tg-header__top-info left-side list-wrap">
                                <li><i className="flaticon-placeholder"></i>59 Mall Road, Amritsar</li>
                                <li><i className="flaticon-mail"></i><a
                                    href="mailto:Petspostinfo@gmail.com">petspostinfo@gmail.com</a></li>
                            </ul>
                        </div>
                        <div className="col-xl-6 col-lg-4">
                            <ul className="tg-header__top-right list-wrap">
                                <li><i className="flaticon-three-o-clock-clock"></i>Opening Hour: 09.00 am - 11.00 pm
                                </li>
